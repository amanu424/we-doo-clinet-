              ...
              <Typography
                ...
                sx={{
                  ...
                  "&::after": {
                    ...
                    transformOrigin: `${
                      currentIndex < prvTabIndex ? "left" : "right"
                    }`, //moving left to right if curent index(new index) is less than previos index.
                  },
                  "&.active": {
                    fontSize: "18px",
                    fontWeight: "bold",
                  ...
                  "&.active::after": {
                    ...
                    transformOrigin: `${
                      currentIndex < prvTabIndex ? "right" : "left"
                    }`, //moving left to right if curent index(new index) is less than previos index.
                  },
                }}
              >
                <Link className="pb-3" to={`${button.path}`}>
                  {button.name}
                </Link>
              </Typography>
            ))}
